...
{
    public partial class INTEXW23Context : DbContext
    {
        public INTEXW23Context()
        {
        }

        public INTEXW23Context(DbContextOptions<INTEXW23Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseNpgsql("Server=awseb-e-3q3wpt42ph-stack-awsebrdsdatabase-mfrf8vsh7xly.ccg49g6j5feb.us-east-1.rds.amazonaws.com;Port=5432;Database=ebdb;userId=postgres;Password=password123;sslmode=Require;Trust Server Certificate=true");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.Squarenorthsouth, e.Northsouth, e.Squareeastwest, e.Eastwest, e.Area, e.Burialnumber })
                    .HasName("main$bodyanalysischart_pkey");
